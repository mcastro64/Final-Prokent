...
zip <- "14201"
beds <- 2
path <-paste(domain, "/apartments/", zip,  sep="") #, city, "-", state, "-" "/beds=", beds,
...
result_container <- realestate_data %>% 
  html_element(xpath = '//div[@class="Layout_layout-container__vzkoA"]' )  %>% 
...
#  html_element(xpath = '//div[@class="search-pagination"]') %>% 
#  html_text() 
...
#  html_elements(xpath = '//div[@class="BasePropertyCard_propertyCardWrap__Z5y4p"]' ) %>%
#  html_text() 
